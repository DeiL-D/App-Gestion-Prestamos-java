...
<form method="post" action="portatilesPorAlumnos">
      <div>
          <br/>
          <br/>
          ...
          <div class="form-group row">
              <div class="col-sm-4">
                  <input type="number" class="form-control" name="alumnPortatil" placeholder="Introduce el id del alumno, ejemplo: 1" required>
              </div>
          </div>
          <br/>
          <br/>
